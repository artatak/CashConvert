...
function clearVal() {
	window.location.reload(); // Rechargement de la page pour réinitialiser les valeurs
	document.getElementsByClassName("finalValue").innerHTML = ""; // Réinitialisation de la valeur convertie
};
